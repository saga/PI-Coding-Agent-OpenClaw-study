...
![文本及其位置ID](images/multimodal-rope-text-position.png)
...
![图片及其位置坐标](images/multimodal-rope-image-position.png)
...
![文本和图片都展平为一维来处理](images/multimodal-rope-flatten-1d.png)
...
![模拟排版统一构建二维位置坐标](images/multimodal-rope-layout-2d.png)
...
![支持退化为RoPE-1D的二维位置](images/rope-tie-2d-position.png)
