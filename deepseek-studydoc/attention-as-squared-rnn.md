...
![图一：常见RNN](images/attention-as-rnn-common.svg)
...
![图二：不断"翻书"的RNN](images/attention-as-rnn-bookflip.svg)
...
![图三：Causal Attention对应的RNN](images/causal-attention-rnn.svg)
...
![图四：两层Attention对应的RNN](images/two-layer-attention-rnn.svg)
